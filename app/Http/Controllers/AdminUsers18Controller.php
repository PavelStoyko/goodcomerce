<?php namespace App\Http\Controllers;
	...
	class AdminUsers18Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Password','name'=>'password','type'=>'password','validation'=>'required|min:3|max:32','width'=>'col-sm-10','help'=>'Minimum 5 characters. Please leave empty if you did not change the password.'];
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select', 'dataenum'=>'Active;Passive;Baned'];
